#!/bin/bash
#SBATCH --job-name=Trans-SVNet_Test
#SBATCH --output=/home/ppak/outputs/Trans_SVNet.txt
#SBATCH --error=/home/ppak/outputs/Trans_SVNet_ERROR.txt
...
python3 ${home}/surgical_adventure/final_code/src/Trans-SVNet/generate_LFB.py
