#!/bin/bash
#SBATCH --job-name=TCN_features
#SBATCH --output=/home/ppak/outputs/TCN.txt
#SBATCH --error=/home/ppak/outputs/TCN_ERROR.txt
...
python3 ${home}/surgical_adventure/src/Trans-SVNet/tecno.py
