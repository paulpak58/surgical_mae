...
def parse_arguments(
    ...
    # Finetune
    parser.add_argument("--model", action="store", default="mvitv2", help="")
    parser.add_argument("--model_size", action="store", default="base", help="")
    parser.add_argument("--pretrain", action="store_true", help="")
    parser.add_argument("--finetune_ckpt_dir", action="store", default="", help="")
    
    # Masked pretrain
    parser.add_argument("--mask_model", action="store", default="maskfeat", help="")
    parser.add_argument("--backbone", action="store", default="mvitv2_S", help="")
    parser.add_argument("--ckpt_dir", action="store", default="", help="")
