# Inspired by https://github.com/ShirAmir/dino-vit-features
# Revised by Paul Pak
...
def pca(image_paths, load_size: int = 224, layer: int = 11, facet: str = 'key', bin: bool = False, stride: int = 4,
    ...
    for image_path in image_paths:
        ...
        descs = extractor.extract_descriptors(image_batch.to(device), layer, facet, bin, include_cls=False).cpu().detach().numpy()
