...
import data_utils.sages_pb2
from data_utils.base_utils import MissingAnnotationsError
from data_utils.sages_pb2 import *
...
def load_protobuf_dir(
    ...
    if phase_translation_file is not None:
        from data_utils.base_utils import read_phase_mapping
