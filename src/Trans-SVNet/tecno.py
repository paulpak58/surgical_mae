...
train_labels_80, train_num_each_80, train_start_vidx,\
    ...
    test_labels_80, test_num_each_80, test_start_vidx = get_data('/home/ppak/surgical_adventure/src/Trans-SVNet/train_val_paths_labels1.pkl')




with open("/home/ppak/surgical_adventure/src/Trans-SVNet/LFB/g_LFB50_train0.pkl", 'rb') as f:
    g_LFB_train = pickle.load(f)
with open("/home/ppak/surgical_adventure/src/Trans-SVNet/LFB/g_LFB50_val0.pkl", 'rb') as f:
    g_LFB_val = pickle.load(f)
with open("/home/ppak/surgical_adventure/src/Trans-SVNet/LFB/g_LFB50_test0.pkl", 'rb') as f:
...
for epoch in range(max_epochs):
    ...
    '''
    model_name = 'TeCNO'
    pred_name = model_name + '_val' + '_L30_SEQ10' + '.pkl'
    # pred_score_name = model_name + '_val' +'_score'+ '_L30_SEQ10' + '.pkl'
    with open(pred_name, 'wb') as f:
        pickle.dump(val_all_preds_phase, f)
    with open(pred_score_name, 'wb') as f:
        pickle.dump(val_all_labels_phase, f)
    '''
...
pred_name = model_name + '_test' + '_length30' + "_new" + "_weights" + '.pkl'
with open(pred_name, 'wb') as f:
    pickle.dump(best_test_all_preds_phase, f)
"""
pred_score_name = model_name + '_test' +'_score' + '_length30' + '_new' + '.pkl'
with open(pred_score_name, 'wb') as f:
