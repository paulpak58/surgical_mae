...
def train_model(train_dataset, train_num_each, val_dataset, val_num_each):
    ...
    if not load_exist_LFB:
        ...
        #'''
        with open("/home/ppak/surgical_adventure/src/Trans-SVNet/LFB/g_LFB_train0.pkl", 'wb') as f:
            pickle.dump(g_LFB_train, f)

        with open("/home/ppak/surgical_adventure/src/Trans-SVNet/LFB/g_LFB_val0.pkl", 'wb') as f:
            pickle.dump(g_LFB_val, f)
        #'''
        with open("/home/ppak/surgical_adventure/src/Trans-SVNet/LFB/g_LFB_test0.pkl", 'wb') as f:
...
def main():
    ...
    val_dataset, val_num_each, test_dataset, test_num_each = get_data('/home/ppak/surgical_adventure/src/Trans-SVNet/train_val_paths_labels1.pkl')
