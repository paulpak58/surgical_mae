...
model_name = 'TeCNO50_epoch_10_train_9552_val_8719_test_8541_new_weights'
...
# model_name1 = 'TeCNO50_trans1_3_5_1_length_30_epoch_0_train_8769_val_9054'
# model1.load_state_dict(torch.load(model_path+model_name1+'.pth'))
model1.cuda()
