...
if num_labels == (num_preds + (sequence_length - 1) * num_video):
    ...
    count = 0
    for i in range(40,80):
        filename = '/home/ppak/surgical_adventure/src/Trans-SVNet/eval/result_L30/phase/video' + str(1 + i) + '-phase.txt'
        gt_filename = '/home/ppak/surgical_adventure/src/Trans-SVNet/eval/result_L30/gt-phase/video' + str(1 + i) + '-phase.txt'
        f = open(filename, 'w')
        #f.write('Frame Phase')
        #f.write('\n')
