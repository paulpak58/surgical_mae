...
import torchvision
from transforms import RandomCrop, RandomHorizontalFlip, RandomRotation, ColorJitter, Cholec80DatasetMasked
import pickle
...
def main():
    ...
    train_dataset = Cholec80DatasetMasked(train_paths_80, train_labels_80, sequence_length, mask_generator, train_transforms)
    val_dataset = Cholec80DatasetMasked(val_paths_80, val_labels_80, sequence_length, mask_generator, test_transforms)
    test_dataset = Cholec80DatasetMasked(test_paths_80, test_labels_80, sequence_length, mask_generator, test_transforms)
